...
const router = createRouter({
  ...
  routes: [
    ...
    // ── Customer ─────────────────────────────────────────────────────────────
    { path: '/dashboard', name: 'dashboard',  component: () => import('@/views/dashboard/DashboardView.vue'),           meta: { requiresAuth: true, title: 'Home' } },
    { path: '/send',      name: 'send-money', component: () => import('@/views/dashboard/SendMoneyView.vue'),           meta: { requiresAuth: true, requiresKyc: true, title: 'Send Money' } },
    { path: '/topup',     name: 'topup',      component: () => import('@/views/dashboard/TopUpView.vue'),               meta: { requiresAuth: true, title: 'Top Up' } },
    { path: '/withdraw',  name: 'withdraw',   component: () => import('@/views/dashboard/WithdrawView.vue'),            meta: { requiresAuth: true, title: 'Withdraw' } },
    { path: '/history',   name: 'history',    component: () => import('@/views/dashboard/TransactionHistoryView.vue'), meta: { requiresAuth: true, title: 'Transaction History' } },
    { path: '/profile',   name: 'profile',    component: () => import('@/views/dashboard/ProfileView.vue'),            meta: { requiresAuth: true, title: 'Profile' } },
    { path: '/kyc',       name: 'kyc',        component: () => import('@/views/kyc/KycView.vue'),                      meta: { requiresAuth: true, title: 'KYC Verification' } },
    { path: '/security',  name: 'security',   component: () => import('@/views/dashboard/SecurityView.vue'),           meta: { requiresAuth: true, title: 'Security' } },
    { path: '/rewards',   name: 'rewards',    component: () => import('@/views/dashboard/RewardsView.vue'),            meta: { requiresAuth: true, title: 'Rewards' } },
