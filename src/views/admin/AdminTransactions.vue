...
.tx-table { width: 100%; border-collapse: collapse; min-width: 800px; background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; }
.tx-table th { text-align: left; font-size: 11px; text-transform: uppercase; letter-spacing: 0.05em; color: #64748b; background: #f8fafc; padding: 12px 16px; border-bottom: 1px solid #e2e8f0; white-space: nowrap; font-weight: 700; }
.tx-table td { padding: 12px 16px; font-size: 13px; color: #334155; border-bottom: 1px solid #f1f5f9; vertical-align: middle; }
