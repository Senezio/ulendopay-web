...
const statuses = {
  none:     { color: 'var(--text-secondary)', bg: '#ffffff11', icon: '○', text: 'Not submitted' },
  pending:  { color: 'var(--accent-amber)',   bg: '#ffb93822', icon: '◌', text: 'Under review' },
  verified: { color: 'var(--accent)',         bg: 'var(--accent-dim)', icon: '◉', text: 'Verified' },
  rejected: { color: 'var(--danger)',         bg: '#ff444422', icon: '✕', text: 'Rejected' },
}
